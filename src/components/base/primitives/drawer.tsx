...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay ref={ref} className={cx("fixed inset-0 z-50 bg-black/80", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description ref={ref} className={cx("text-sm text-muted-foreground", className)} {...props} />
));
