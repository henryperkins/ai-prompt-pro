  ...
  return (
    <header className="relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 [mask-image:radial-gradient(60%_60%_at_50%_35%,black,transparent)] bg-black/55" />
        {/* Rune overlay */}
        <div
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pt-6 pb-16">
        ...
        <nav className="flex items-center justify-between gap-6">
          ...
          <div className="hidden md:flex items-center gap-7">
            {links.map((l) => (
              <a key={l.href} href={l.href} className="pf-nav-link text-sm font-semibold">
                {l.label}
              </a>
            ))}
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className={cx("pf-button pf-button-ghost", "h-10 px-4 text-sm")}
            >
              {secondaryCta.label}
            </a>
            <a
              href={primaryCta.href}
              className={cx("pf-button pf-button-primary", "h-10 px-4 text-sm")}
            >
              {primaryCta.label}
            </a>
          </div>
        ...
        <section className="mt-12 md:mt-16">
          <div className="pf-gilded-frame p-7 md:p-10">
            <div className="max-w-2xl">
              ...
              <h1 className="pf-text-display mt-5 text-4xl md:text-6xl leading-[1.02]">
                {headline}
              </h1>

              <p className="mt-4 text-base md:text-lg text-[rgba(230,225,213,.82)]">
                {subhead}
              </p>
              ...
              <div className="mt-7 flex flex-col sm:flex-row gap-3">
                <a
                  href={primaryCta.href}
                  className={cx("pf-button pf-button-primary", "h-12 px-6")}
                >
                  {primaryCta.label}
                </a>
                <a
                  href={secondaryCta.href}
                  className={cx("pf-button pf-button-secondary", "h-12 px-6")}
                >
                  {secondaryCta.label}
                </a>
              </div>
