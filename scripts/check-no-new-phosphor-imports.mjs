...
const approvedPhosphorImportFiles = new Set([
  ...
  "src/components/OutputPanelDetailsAccordion.tsx",
  "src/components/OutputPanelEnhanceControls.tsx",
  "src/components/OutputPanelHeader.tsx",
  "src/components/OutputPanelWorkflow.tsx",
  "src/components/WebSearchActivityIndicator.tsx",
